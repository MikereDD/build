...
# Clears out SystemUI/Settings/framework-res
.PHONY: uiclean
uiclean:
	@rm -rf $(OUT_DIR)/target/product/*/system/framework/framework-res.apk
	@rm -rf $(OUT_DIR)/target/product/*/system/priv-app/Settings
	@rm -rf $(OUT_DIR)/target/product/*/system/priv-app/SystemUI
	@echo -e ${CL_GRN}"SystemUI, Settings, and framework-res have been erased"${CL_RST}
